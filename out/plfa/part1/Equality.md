...
{% raw %}<pre class="Agda"><a id="19658" class="Keyword">open</a> <a id="19663" class="Keyword">import</a> <a id="19670" href="https://agda.github.io/agda-stdlib/v1.3/Level.html" class="Module">Level</a> <a id="19676" class="Keyword">using</a> <a id="19682" class="Symbol">(</a><a id="19683" href="Agda.Primitive.html#423" class="Postulate">Level</a><a id="19688" class="Symbol">;</a> <a id="19690" href="Agda.Primitive.html#636" class="Primitive Operator">_⊔_</a><a id="19693" class="Symbol">)</a> <a id="19695" class="Keyword">renaming</a> <a id="19704" class="Symbol">(</a><a id="19705" href="Agda.Primitive.html#590" class="Primitive">zero</a> <a id="19710" class="Symbol">to</a> <a id="lzero"></a><a id="19713" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Equality.md %}{% raw %}#19713" class="Primitive">lzero</a><a id="19718" class="Symbol">;</a> <a id="19720" href="Agda.Primitive.html#606" class="Primitive">suc</a> <a id="19724" class="Symbol">to</a> <a id="lsuc"></a><a id="19727" href="{% endraw %}{{ site.baseurl }}{% link out/plfa/part1/Equality.md %}{% raw %}#19727" class="Primitive">lsuc</a><a id="19731" class="Symbol">)</a>
...
{% raw %}<pre class="Agda"><a id="21878" class="Comment">-- import Relation.Binary.PropositionalEquality as Eq</a>
<a id="21932" class="Comment">-- open Eq using (_≡_; refl; trans; sym; cong; cong-app; subst)</a>
<a id="21996" class="Comment">-- open Eq.≡-Reasoning using (begin_; _≡⟨⟩_; step-≡; _∎)</a>
